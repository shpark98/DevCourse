...
# Augmentation
aug = A.Compose([
    # A.CoarseDropout(max_holes=20, max_height=40, max_width=40, min_holes=None, min_height=None, min_width= None, fill_value=0, mask_fill_value=0, always_apply=False, p=1.0),
